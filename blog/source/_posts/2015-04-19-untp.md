title: "一个命令行的 TexturePacker 拆解工具"
date: 2015-04-19 08:19:17
tags: [Tool, TexturePacker]
---
...
首先想到的是 [@偶尔e网事][2] 同学的[Anti_TexturePacker][1], 非常好用, 我经常推荐给有需要的朋友. 不过目前只能运行在 Windows 上, 而且不止命令行, 我们的特效有好几百个, 一个一个来的话会死人的哦~
