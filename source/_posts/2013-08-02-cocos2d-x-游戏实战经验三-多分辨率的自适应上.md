...
**1.官网上的这篇:**[http://www.cocos2d-x.org/projects/cocos2d-x/wiki/Multi_resolution_support](http://www.cocos2d-x.org/projects/cocos2d-x/wiki/Multi_resolution_support)

![](/images/dd33303e0e7da50006a51f6960f7b7e053956357.jpg)

英文文章,用心看的话应该都能看懂,讲的是cocos2d 2.x版本自带的3种适配方案,推荐看下!



**2.Alex Zhou的程序世界上的这篇:**[http://codingnow.cn/cocos2d-x/975.html](http://codingnow.cn/cocos2d-x/975.html)

![](/images/2cc69c2640b0c3186961f9afbda08c44eb95a1cc.png)

这篇文章主要讲的也是cocos2d 2.x版本自带的3种适配方案,讲的还是蛮清晰,图文并茂还是很值得一看的!



**3.我是妖怪大大的这篇:**[http://dualface.github.io/blog/2012/08/17/cocos2d-x-2-dot-0-multi-resolution/](http://dualface.github.io/blog/2012/08/17/cocos2d-x-2-dot-0-multi-resolution/)

![](/images/b2281445091932aa131d452b72cc76dda84cc995.png)

我是妖怪大大的这篇文章是主要讲的是多分辨率的原理,写的非常棒,我的很多想法都是从这篇文章中学习到的,就是源码中的实现我不是很赞同,毕竟现在手动去编写UI真的不多了!



**4.无间落叶大大的这篇:**[http://blog.leafsoar.com/archives/2013/05-10-19.html](http://blog.leafsoar.com/archives/2013/05-10-19.html)

![](/images/f0148a4e25409840d55e788f64ed3df3e1c377c6.png)

大家看到的最多的应该就是无间落叶大大的这篇文章了,泰然上曾经顶置了一段时间的,文章讲的十分详细,从理论知识到具体实现都有讲到,如果你能耐心看完的话,受益匪浅!



**5.还有K.C大大的讲cocosbuider的这篇:**[http://i.kimiazhu.info/?p=119](http://i.kimiazhu.info/?p=119)

![](/images/06423794f1fc5b6e7d25e9acc7302e386cf844af.png) ![](/images/d3e8d9da8214469156173ee3ab57855c1f99261f.png) ![](/images/5e7b20ffce693668c8f32ab8759b42bfe3a32d43.png)
...
### 二.宽高比与分辨率的知识![](/images/0a864b38cca31ecd05c9d0d41054418faaa085ac.gif)
...
### 三.cocos2d-x 2.x版本自带的自适应方法分析![](/images/1f4a3872a9b1f2052a7977b10115f8da8b30de7a.gif)

请看下图,这是在DesignResolutionSize为480x320,设备尺寸480x320正常效果下的HelloCpp:

![](/images/579f48e4c688a450ae8d49126d09610b96c7189e.png)
...
![](/images/dba3ac84e3e0b8a8e98fb1dabc28e3b65cd2fa38.png)
**kResolutionShowAll**按照宽和高的缩放系数的较小值去缩放画面,因为是等比缩放,所以不会失真,但是较大缩放系数的方向会出现黑边!如下图:

![](/images/e5bbf3d9723513b07824a30fc413b3a84f09d26d.png)
...
### 四.思路分析![](/images/1ba0cb1f1e7d5ff473b325f73af08452e241f952.gif)
...
![](/images/b1c206d2b62dc4f96e1e023c09e61ec0de6af1e5.png)

**2).显示更多的游戏内容,一般用在原本游戏内容就大于视口的游戏中!**比如COC类游戏:

![](/images/ed479502226a8e332a4c68a4e5c5c60c1a622208.jpg)
...
![](/images/a746748792116d13d6c32618249ec41b8aa4c46e.png)
...
![](/images/0e4ced915f3cf322683623dac6b47be1af87aa3f.png)
...
![](/images/65c61ba4a245a1a26071acb7a60c17e2b873e1d4.png)

![](/images/30da72dd00b014e4d929cb32b1b3b7a0d51708e9.png)
